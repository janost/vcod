//	Truthiness of the empty string, alone: it is fatal on retail.
...
main()
{
	...
	logPrint("PROBE at truthy_empty_string\n");
	if ("")
		logPrint("PROBE truthy_empty_string 1\n");
	else
		logPrint("PROBE truthy_empty_string 0\n");
}
