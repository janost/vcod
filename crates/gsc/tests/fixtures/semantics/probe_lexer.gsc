//	Lexer edge cases. May fail to compile; the failure is the measurement.
...
main()
{
	...
	i = 7;
	count = 3;
	logPrint("PROBE mod_tight " + (i%count) + "\n");
	logPrint("PROBE int_min_cast " + (int)(-2147483648) + "\n");
	logPrint("PROBE int_min_direct " + (-2147483648) + "\n");
}
